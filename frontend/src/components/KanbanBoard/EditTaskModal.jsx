...
const EditTaskModal = ({ isOpen, onClose, task, onRefresh, token }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Modal Header */}
        <div className="p-4 border-b-2 flex items-center justify-between" style={{ borderColor: '#131214' }}>
        ...
        <div className="p-4 space-y-4">
          {/* Title */}
          <div>
            <label className="block text-xs font-medium mb-1" style={{ color: '#131214', opacity: 0.6 }}>
              Title
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 mt-3">
              ...
              {editTags.length === 0 && (
                <span className="text-xs" style={{ color: '#131214', opacity: 0.3 }}>
                  No tags yet
                </span>
              )}
            </div>
        ...
        {/* Modal Footer */}
        <div className="p-4 border-t-2 flex gap-2 justify-end" style={{ borderColor: '#131214' }}>
          <button
            onClick={onClose}
