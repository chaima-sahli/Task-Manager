    ...
    <>
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-3 z-40">
        ...
        >
          ...
          <span className="hidden group-hover:flex text-xs font-mono font-normal">n</span>
        </button>
      </div>
          ...
          >
            ...
            <div className="space-y-2">
              {shortcuts.map((shortcut, index) => (
                ...
                >
                  <span className="text-sm" style={{ color: '#131214', opacity: 0.6 }}>
                    {shortcut.action}
                  </span>
                  <kbd
            ...
            <p className="text-xs mt-4 text-center" style={{ color: '#131214', opacity: 0.3 }}>
